...
### and two independent test sets combinding data from Kosovo and Switzerland. EACH DATASET NEEDS TO BE CREATED SEPARATELY.
...
for country in ['Austria', 'Belgium', 'Luxembourg']:
    ...
    for row in metadata_csv.iterrows():
        ...
        ### Count number of pixels per class. To perform this, insert 0 to beginning of "unique_classes" and uncomment "class_pixels".
